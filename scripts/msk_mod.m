...
% Functions
function h = GMSK_gaussian_filter1(BT, Tb, L, k)
...
BT = 0.5; % bandwidth-time product for Gaussian filter
span = 3; % symbol span for Gaussian filter
gauss_filter = GMSK_gaussian_filter1(BT ,bit_duration, samples_per_bit, span);
